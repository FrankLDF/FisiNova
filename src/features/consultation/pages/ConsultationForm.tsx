              ...
              {!isViewMode && (
                ...
                >
                  <Row gutter={16}>
                    <Col span={24}>
                      <CustomFormItem
                        label="¿Requiere Terapias?"
                        name="requires_therapy"
                        valuePropName="checked"
                      >
                        <Switch
                          checkedChildren="Sí"
                          unCheckedChildren="No"
                          onChange={(checked) => setRequiresTherapy(checked)}
                        />
                      </CustomFormItem>
                    </Col>
                  </Row>
                  ...
                  {requiresTherapy && (
                    <>
                      <Row gutter={16}>
                        <Col span={12}>
                          <CustomFormItem
                            label="Número de Sesiones Recomendadas"
                            name="therapy_sessions_needed"
                            required
                          >
                            <InputNumber
                              min={1}
                      ...
                      <Row gutter={16}>
                        <Col span={24}>
                          <CustomFormItem
                            label="Motivo/Justificación de las Terapias"
                            name="therapy_reason"
                            required
                          >
                            <TextArea
                              rows={3}
                              placeholder="Describa la razón por la cual el paciente requiere terapias..."
                            />
                          </CustomFormItem>
                        </Col>
                      </Row>
                      <Alert
                        message="Las terapias deberán ser autorizadas por la secretaría antes de programarse"
                        type="info"
                        showIcon
                      />
                    </>
